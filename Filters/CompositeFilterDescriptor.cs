...
namespace RoboUI.Filters
{
    ...
    public class CompositeFilterDescriptor : FilterDescriptorBase
    {
        ...
        ///     <see cref="P:MvcCornerstone.Web.UI.RoboUI.Filters.CompositeFilterDescriptor.FilterDescriptors" />.
        /// </summary>
        /// <value>
        ...
        ///     <see cref="P:MvcCornerstone.Web.UI.RoboUI.Filters.CompositeFilterDescriptor.FilterDescriptors" />
        ///     expressions with <see cref="P:MvcCornerstone.Web.UI.RoboUI.Filters.CompositeFilterDescriptor.LogicalOperator" />.
        /// </summary>
        ...
        public override object Clone()
        {
            ...
            {
                instance.FilterDescriptors.Add(filterDescriptor.Clone());
            }
            return instance;
        }
    }
