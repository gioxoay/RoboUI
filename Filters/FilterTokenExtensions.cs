...
namespace RoboUI.Filters
{
    ...
    {
        private static readonly IDictionary<string, FilterOperator> tokenToOperator = new Dictionary
        ...
        private static readonly IDictionary<FilterOperator, string> operatorToToken = new Dictionary
