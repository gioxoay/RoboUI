...
{
    /// <summary>
    ///     Base class for all <see cref="T:MvcCornerstone.Web.UI.RoboUI.Filters.IFilterDescriptor" /> used for
    ...
    public abstract class FilterDescriptorBase : IFilterDescriptor
    {
        ...
        ///     <see cref="M:MvcCornerstone.Web.UI.RoboUI.Filters.FilterDescriptorBase.CreateFilterExpression(System.Linq.Expressions.ParameterExpression)" />
        ///     , if
